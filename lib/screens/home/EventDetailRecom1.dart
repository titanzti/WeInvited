...
class PostDetailsRecom1V1 extends StatefulWidget {
  ...
  PostDetailsRecom1V1(
      this.postsrecom1, this.userData, this.joinEvent1, this.interest2);

  @override
  _PostDetailsRecom1V1State createState() =>
      _PostDetailsRecom1V1State(postsrecom1, joinEvent1);
}

class _PostDetailsRecom1V1State extends State<PostDetailsRecom1V1>
    with TickerProviderStateMixin {
  ThemeData themeData;
  final JoinEvent joinEvent1;

  _PostDetailsRecom1V1State(this.postDetails, this.joinEvent1);
  ...
  var start = "(";
  var end = ".";
  Postrecom1 postDetails = Postrecom1();
