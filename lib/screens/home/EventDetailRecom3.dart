...
class PostDetailsRecom3V1 extends StatefulWidget {
  ...
  PostDetailsRecom3V1(
      this.postsrecom3, this.userData, this.joinEvent1, this.interest4);

  @override
  _PostDetailsRecom3V1State createState() =>
      _PostDetailsRecom3V1State(postsrecom3, joinEvent1);
}

class _PostDetailsRecom3V1State extends State<PostDetailsRecom3V1>
    with TickerProviderStateMixin {
  ThemeData themeData;
  final JoinEvent joinEvent1;

  _PostDetailsRecom3V1State(this.postDetails, this.joinEvent1);
  ...
  var start = "(";
  var end = ".";
  Postrecom3 postDetails = Postrecom3();
