...
class PostDetailsRecomV1 extends StatefulWidget {
  ...
  PostDetailsRecomV1(
      this.postsrecom, this.userData, this.joinEvent1, this.interest1);

  @override
  _PostDetailsRecomV1State createState() =>
      _PostDetailsRecomV1State(postsrecom, joinEvent1);
}

class _PostDetailsRecomV1State extends State<PostDetailsRecomV1>
    with TickerProviderStateMixin {
  ThemeData themeData;
  final JoinEvent joinEvent1;

  _PostDetailsRecomV1State(this.postDetails, this.joinEvent1);
  ...
  var start = "(";
  var end = ".";
  Postrecom postDetails = Postrecom();
