...
import 'package:we_invited/screens/home/EventDetailRecom1.dart';

class PostListRecom1View extends StatefulWidget {
  final Postrecom1 postsrecom1;
  ...
  @override
  _PostListRecom1ViewState createState() =>
      _PostListRecom1ViewState(postsrecom1, postNotifier, joinEvent);
}

class _PostListRecom1ViewState extends State<PostListRecom1View> {
  final Postrecom1 postsrecom;
  final PostNotifier postNotifier;
  final JoinEvent joinEvent;
  ThemeData themeData;
          ...
          var navigationResult = await Navigator.of(context).push(
            CupertinoPageRoute(
              builder: (BuildContext context) => ChangeNotifierProvider(
                ...
                builder: (context, child) => PostDetailsRecom1V1(
                    postsrecom, user, joinEvent, widget.interest2),
              ),
            ),
          );
