...
class PostDetailsRecom4V1 extends StatefulWidget {
  ...
  PostDetailsRecom4V1(
      this.postsrecom4, this.userData, this.joinEvent1, this.interest5);

  @override
  _PostDetailsRecom4V1State createState() =>
      _PostDetailsRecom4V1State(postsrecom4, joinEvent1);
}

class _PostDetailsRecom4V1State extends State<PostDetailsRecom4V1>
    with TickerProviderStateMixin {
  ThemeData themeData;
  final JoinEvent joinEvent1;

  _PostDetailsRecom4V1State(this.postDetails, this.joinEvent1);
  ...
  var start = "(";
  var end = ".";
  Postrecom4 postDetails = Postrecom4();
