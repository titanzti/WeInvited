...
import 'package:we_invited/screens/home/EventDetailRecom3.dart';

class PostListRecom3View extends StatefulWidget {
  final Postrecom3 postsrecom3;
  ...
  @override
  _PostListRecom3ViewState createState() =>
      _PostListRecom3ViewState(postsrecom3, postNotifier, joinEvent);
}

class _PostListRecom3ViewState extends State<PostListRecom3View> {
  final Postrecom3 postsrecom;
  final PostNotifier postNotifier;
  final JoinEvent joinEvent;
  ThemeData themeData;
    ...
    checkInternetConnectivity().then((value) => {
          value == true
              ? () {
                  ...
                  // numreq=0;
                  getCloudFirestore();
                  otheremail = postsrecom.emailuser;
                  mypostid = postsrecom.postid;
                  getlikes(mypostid);
  ...
  Future getCloudFirestore() async {
    ...
    FirebaseFirestore.instance
      ...
      querySnapshot.docs.forEach((value) {
        ...
        if ((value.exists) && value.get('requestpostid') == postsrecom.postid) {
          print(value.get('requestpostid'));
          ...
          var navigationResult = await Navigator.of(context).push(
            CupertinoPageRoute(
              builder: (BuildContext context) => ChangeNotifierProvider(
                ...
                builder: (context, child) => PostDetailsRecom3V1(
                    postsrecom, user, joinEvent, widget.interest4),
              ),
            ),
          );
                                    ...
                                    Row(
                                      ...
                                      children: <Widget>[
                                        ...
                                        Container(
                                          ...
                                          child: Text(
                                            '${format2.format(postsrecom.startdateTime.toDate())} -${format3.format(postsrecom.entdateTime.toDate())} ',
                                            style: AppTheme.getTextStyle(
                                                themeData.textTheme.caption,
                                                fontSize: 14,
                                                color: Colors.black,
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        children: <Widget>[
                                          ...
                                          // ),
                                          Text(
                                            ' $totalreq/${postsrecom.Numpeople} จำนวนผู้เข้าร่วม',
                                            style: TextStyle(
                                                fontSize: 14,
                                                color: Colors.black
                                                    .withOpacity(0.8)),
                    ...
                    child: IconButton(
                      ...
                      onPressed: liked
                          ? () {
                              setState(() {
                                liked = false;
                                unlikepost(totallike, postsrecom.postid);
                              });
                            }
                          : () {
                              setState(() {
                                liked = true;
                                likepost(totallike, postsrecom.postid);
                              });
                            },
                      icon: liked
