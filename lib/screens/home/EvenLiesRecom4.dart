...
import 'package:we_invited/screens/home/EventDetailRecom4.dart';

class PostListRecom4View extends StatefulWidget {
  final Postrecom4 postsrecom4;
  ...
  @override
  _PostListRecom4ViewState createState() =>
      _PostListRecom4ViewState(postsrecom4, postNotifier, joinEvent);
}

class _PostListRecom4ViewState extends State<PostListRecom4View> {
  final Postrecom4 postsrecom;
  final PostNotifier postNotifier;
  final JoinEvent joinEvent;
  ThemeData themeData;
          ...
          var navigationResult = await Navigator.of(context).push(
            CupertinoPageRoute(
              builder: (BuildContext context) => ChangeNotifierProvider(
                ...
                builder: (context, child) => PostDetailsRecom4V1(
                    postsrecom, user, joinEvent, widget.interest5),
              ),
            ),
          );
