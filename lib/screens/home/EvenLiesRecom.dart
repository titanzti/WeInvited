...
import 'package:we_invited/screens/home/EventDetailRecom.dart';
...
class PostListRecomView extends StatefulWidget {
  final Postrecom postsrecom;
  ...
  @override
  _PostListRecomViewState createState() =>
      _PostListRecomViewState(postsrecom, postNotifier, joinEvent);
}

class _PostListRecomViewState extends State<PostListRecomView> {
  final Postrecom postsrecom;
  final PostNotifier postNotifier;
  final JoinEvent joinEvent;
  ThemeData themeData;
          ...
          var navigationResult = await Navigator.of(context).push(
            CupertinoPageRoute(
              builder: (BuildContext context) => ChangeNotifierProvider(
                ...
                builder: (context, child) => PostDetailsRecomV1(
                    postsrecom, user, joinEvent, widget.interest1),
              ),
            ),
          );
