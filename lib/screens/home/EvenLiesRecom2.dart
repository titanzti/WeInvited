...
import 'package:we_invited/screens/home/EventDetailRecom2.dart';

class PostListRecom2View extends StatefulWidget {
  ...
  @override
  _PostListRecom2ViewState createState() =>
      _PostListRecom2ViewState(postsrecom2, postNotifier, joinEvent);
}

class _PostListRecom2ViewState extends State<PostListRecom2View> {
  final Postrecom2 postsrecom;
  final PostNotifier postNotifier;
  final JoinEvent joinEvent;
  ThemeData themeData;
          ...
          var navigationResult = await Navigator.of(context).push(
            CupertinoPageRoute(
              builder: (BuildContext context) => ChangeNotifierProvider(
                ...
                builder: (context, child) => PostDetailsRecom2V1(
                    postsrecom, user, joinEvent, widget.interest3),
              ),
            ),
          );
