...
class _EventUserListState extends State<EventUserList> {
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        visibilitybutt == false && chreckstatus =='request'?  new  InkWell(
                            onTap: () async {
  ...
  updateStateaccept(JoinEvent joinEvent) async {
    ...
    CollectionReference profileRef = await FirebaseFirestore.instance
        .collection('JoinEvent').doc(myuid).collection('JoinEventList');
  ...
  updateStatedecline(JoinEvent joinEvent) async {
    print("updateState");
    print(myuid);
    final db = FirebaseFirestore.instance;
    final uEmail = await AuthService().getCurrentEmail();
