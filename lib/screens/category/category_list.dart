...
class categoryList extends StatefulWidget {
  ...
  categoryList(this._title, this._imageUrl);

  @override
  _categoryListState createState() => _categoryListState(_title, _imageUrl);
}
...
class _categoryListState extends State<categoryList> {
  ...
  _categoryListState(this._title, this._imageUrl);
